...
# Prog Purpose: Read in a list of customers and display a report
              # that will increase the amount they owe by 10%
...
def display_cust_list():
    ...
    print(line)
    print(star + " CUSTOMER SALES REPORT " + star)
    ...
    print(line)
    print(star + " TOTAL AMOUNT:\t$" + format(total, fcurrency))
    pass
